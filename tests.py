...
class TestBooksCollector:
    ...
    #дубликат книги не добавляется повторно
    ...
    #книге успешно присваивается жанр
    ...
    #несуществующий жанр не перезаписывает текущий 
    ...
    #но возможно тест избыточный, так как основые проверки были выше 
    def test_get_book_genre_affter_adding_book_list_not_empty(self, collector_book_with_genre):
        assert collector_book_with_genre.get_book_genre(c.BOOK_ANIMATION_FILMS)


    #get_books_with_specific_genre

    #возвращается список книг нужного жанра
    ...
    def test_get_books_with_specific_genre_expecting_genge_returns_books(self, collector_with_many_books, genre, expected):
        assert collector_with_many_books.get_books_with_specific_genre(genre) == expected


    #несуществующий жанр возвращает пустой список
    ...
    def test_dd_book_in_favorites_book_not_from_dick_not_added(self, collector):
        collector.add_book_in_favorites(c.BOOK_NOT_IN_DICT)
        assert c.BOOK_NOT_IN_DICT not in collector.get_list_of_favorites_books()

    def test_dd_book_in_favorites_book_from_dick_added(self, collector_book_with_genre):
    ...
    # книга успешно удалилась из избранного
